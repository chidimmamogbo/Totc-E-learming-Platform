...
const Courses = (): React.JSX.Element => {
  ...
  return (
    <section className="bg-[#F8FAFC] py-16 px-6 sm:px-12 md:px-24 w-full overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-24">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center w-full">
            ...
            <div className="grid grid-cols-7 sm:flex sm:flex-nowrap gap-x-1 gap-y-4 justify-items-center sm:justify-start items-center overflow-visible py-4 w-full">
            ...
            <div className="flex justify-center lg:justify-end w-full min-w-max">
              <Link href="/courses/food-details" className="relative block w-full max-w-[420px] aspect-[460/240] shadow-[0_15px_45px_rgba(38,45,118,0.06)] rounded-2xl overflow-hidden hover:shadow-[0_20px_50px_rgba(38,45,118,0.1)] transition-all">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_0.3fr] gap-8 items-center w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-center justify-start w-full">
              ...
              {/* Center interactive Moon Card drops cleanly onto mobile rows */}
            ...
            {/* Right Column (20% width): Locks pills layout tightly to prevent row wrapping */}
            <div className="flex flex-nowrap gap-x-1 justify-start lg:justify-end items-center py-2 w-full overflow-visible">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full">
            ...
            {/* Right Column (50% width): Tightly Grouped Slanted Multi-Capsule Row */}
            <div className="flex flex-nowrap gap-x-1 justify-start lg:justify-end items-center py-2 w-full overflow-visible">
